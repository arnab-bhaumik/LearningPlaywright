/*
 * File: 21_literals_all.js
 * Purpose: Demonstrates all literals
 */
...
// Template literal 
let first_name = "Arnab";
let full_name = `Hi,${first_name} Bhaumik`;
console.log(full_name) // Output: Hi,Arnab Bhaumik
...
let path = "C:\\users\\arnab\\file.txt";
